...
- 1st level : Arousal ~ 1 + abs_alpha*PN;
- 看Arousal跟alpha的相關性，在positive story跟negative story的狀況下
- 2ns level : P-N estimate ~ 1 + IRI_1 + IRI_2 + IRI_3 + IRI_4
- 看positive story跟negative story的差異是不是會跟IRI有關。
